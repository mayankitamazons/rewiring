...
import Profile from './Admin/Pages/Setting/Profilesetting/Profile';
...
import Community from './Admin/Pages/Community List/Community/Community';
...
import Report from './Admin/Pages/Community List/Report/Report';
import Block from './Admin/Pages/Community List/Block/Block';
import ChallengeViewDays from './Admin/Pages/Challenges/ChallengeViewDays';
import MediatationView from './Admin/Pages/Meditaton/MediatationView';
function App() {
  return (
    <div className="wrapper" >
      <Routes>
        ...
        <Route path='/' element={<Main />} >
          ...
          <Route path='meditation/view/:id' element={<MediatationView />} />
          ...
          <Route path='communityList/community' element={<Community />} />
          <Route path='communityList/report' element={<Report />} />
          <Route path='communityList/block' element={<Block />} />
